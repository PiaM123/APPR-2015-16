...
Naknadno sem uvozila še podatke za delovno aktivnost in povprečno mesečno bruto plačo v Sloveniji, ter za izobrazbo po regijah, da bom lahko narisala zemljevid.

Vsi podatki so samo za leto 2013, ker za Nemčijo nisem dobila podatkov za katerokoli drugo leto in bi bila tako primerjava nemogoča.

V vseh posatkih je število oseb točno število.
...
Tabela 6 prikazuje povprečno mesečno bruto plačo v Sloveniji glede na spol, leto in stopnjo izobrazbe. To tabelo bomo uporabili v 4. fazi. Podatki so uvoženi vobliki CSV. Podatke imamo za leta med 2008 do vključno 2013, izobrazbo pa kot že povsod v projektu ločimo na osnovno, srednjo in visoko.
