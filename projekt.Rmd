...
<<<<<<< HEAD
```{r grafIzobrazbaSpolSlo, echo=FALSE}
...
>>>>>>> 7a72f6a167f7dc020b8b044cbc310a8ab76618b7
...
grafPlace <- ggplot(PlaceAktivnostSlovenija, aes(x=Stopnja.Izobrazbe, y=Povprecna.mesecna.bruto.placa.v.EUR)) +
  geom_bar(stat = "identity") + theme_minimal() + aes(fill=Stopnja.Izobrazbe) +
